import{n as a,j as e,k as f}from"./emotion-styled.browser.esm.XV-wAueI.js";import{r}from"./index.a3y3H-wG.js";import{I as v}from"./index.UdM46z5P.js";import{C as b,H as z}from"./Hero.CEl4phPh.js";import{M as c}from"./index.DCbXLVN6.js";import{B as o}from"./index.DXOhyjAC.js";import{FadeIn as t}from"./FadeIn.Dp3Mh_M9.js";import"./index.DMB71ult.js";/* empty css                      */import"./styled.qC4iL2s4.js";const w=a.section`
    padding: 100px 0;
...
`,N=({children:n,...s})=>n?e.jsx(w,{...s,children:e.jsx(b,{children:e.jsx(y,{children:n})})}):null,S=f`
...
`,k=a.div`                
        ...
        ${c.max("md")} {
            flex-direction: column;
            gap: 0px;
        }`;const B=({})=>{const n="https://us-central1-riasissu-7c453.cloudfunctions.net/passwordProtectedPage?password=",[s,x]=r.useState(""),[d,h]=r.useState(!1),[m,l]=r.useState(null),[g,p]=r.useState(!1);r.useEffect(()=>{localStorage.getItem("authorized")==="true"&&p(!0)});const j=async()=>{if(s.trim()){h(!0),l(null);try{const i=await fetch(`${n}${s}`,{method:"GET",mode:"cors",credentials:"omit"});if(!i.ok)throw new Error("Password errata.");(await i.json()).redirectUrl?(p(!0),localStorage.setItem("authorized","true")):l("Errore: nessun URL ricevuto.")}catch(i){const u=i instanceof Error?i.message:"Errore sconosciuto";l(u||"Errore di connessione.")}finally{h(!1)}}};return g?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    .button-container {
        margin-bottom: 3rem;
        width: 100%;
        display: flex;
