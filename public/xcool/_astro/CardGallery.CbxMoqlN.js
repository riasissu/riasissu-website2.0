...
`,a=r.div`
  ...
  font-size: 14px;
  color: #cbcacd;
`,F=()=>o.jsx(s,{children:o.jsx(S,{children:o.jsx(v,{children:z.map(i=>{const l=i.title=="Tennis"?"high":"auto";return o.jsxs(j,{href:i.href,children:[o.jsx(C,{src:i.imgSrc,alt:i.title,fetchPriority:l}),o.jsxs(y,{children:[o.jsx(T,{children:i.title}),i.format&&o.jsxs(a,{children:[o.jsx("strong",{children:"Formato: "}),i.format]}),i.participants&&o.jsxs(a,{children:[o.jsx("strong",{children:"Partecipanti: "}),i.participants]}),i.description&&o.jsxs(a,{children:[o.jsx("strong",{children:"Descrizione: "}),i.description]})]})]},i.href)})})})});export{F as default};
