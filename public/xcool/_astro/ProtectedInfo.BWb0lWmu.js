import{n as r,j as i,k as c}from"./emotion-styled.browser.esm.BazEBxOH.js";import{r as t}from"./index.Cj_FO6QK.js";import"./styled.DFdm9DVt.js";import{C as d,H as h}from"./Hero.DwhLfrLK.js";import{M as a}from"./index.pRwWRSYz.js";import{B as e}from"./index.B-8IYzES.js";import{FadeIn as s}from"./FadeIn.DcbDPFXb.js";import"./index.xlHDj9e3.js";import"./index.DeykM7ZR.js";/* empty css                      */import"./styled.Ub7titi9.js";const m=r.section`
    padding: 100px 0;
...
`,x=({children:n,...o})=>n?i.jsx(m,{...o,children:i.jsx(d,{children:i.jsx(p,{children:n})})}):null,u=c`
...
`;r.div`                
        ...
        ${a.max("md")} {
            flex-direction: column;
            gap: 0px;
        }`;const A=({})=>{const[n,o]=t.useState(""),[g,j]=t.useState(!1),[v,f]=t.useState(null),[b,l]=t.useState(!1);return t.useEffect(()=>{localStorage.getItem("authorized")==="true"&&l(!0)}),i.jsxs(i.Fragment,{children:[i.jsx("style",{children:`
    .button-container {
        margin-bottom: 3rem;
        width: 100%;
        display: flex;
