...
`;r.div`                
        ...
        ${o.max("md")} {
            flex-direction: column;
            gap: 0px;
        }`;const S=({})=>{s.useState(""),s.useState(!1),s.useState(null);const[a,n]=s.useState(!1);return s.useEffect(()=>{localStorage.getItem("authorized")==="true"&&n(!0)}),i.jsxs(i.Fragment,{children:[i.jsx("style",{children:`
    .button-container {
        margin-bottom: 3rem;
        width: 100%;
        display: flex;
