...
`,y=a.div`
  ...
  font-size: 14px;
  color: #cbcacd;
`,B=()=>t.jsx(n,{children:t.jsx(S,{children:t.jsx(u,{children:F.map(i=>{const l=i.title=="Salto in Alto Maschile"?"high":"auto";return t.jsxs(w,{href:i.href,children:[t.jsx(v,{src:i.imgSrc,alt:i.title,fetchPriority:l}),t.jsxs(_,{children:[t.jsx(j,{children:i.title}),t.jsxs(y,{children:[t.jsx("strong",{children:"Partecipanti: "}),i.participants]})]})]},i.href)})})})});export{B as default};
