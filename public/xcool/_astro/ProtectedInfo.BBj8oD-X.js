import{n as r,j as i,k as c}from"./emotion-styled.browser.esm.BazEBxOH.js";import{r as s}from"./index.Cj_FO6QK.js";import"./styled.DFdm9DVt.js";import{C as d,H as m}from"./Hero.DwhLfrLK.js";import{M as a}from"./index.pRwWRSYz.js";import{B as e}from"./index.B-8IYzES.js";import{FadeIn as t}from"./FadeIn.DcbDPFXb.js";import"./index.xlHDj9e3.js";import"./index.DeykM7ZR.js";/* empty css                      */import"./styled.Ub7titi9.js";const h=r.section`
    padding: 100px 0;
...
`,x=({children:n,...o})=>n?i.jsx(h,{...o,children:i.jsx(d,{children:i.jsx(p,{children:n})})}):null,u=c`
...
`;r.div`                
        ...
        ${a.max("md")} {
            flex-direction: column;
            gap: 0px;
        }`;const P=({})=>{const[n,o]=s.useState(""),[g,j]=s.useState(!1),[f,v]=s.useState(null),[b,l]=s.useState(!1);return s.useEffect(()=>{localStorage.getItem("authorized")==="true"&&l(!0)}),i.jsxs(i.Fragment,{children:[i.jsx("style",{children:`
    .button-container {
        margin-bottom: 3rem;
        width: 100%;
        display: flex;
