...
`,a=r.div`
  ...
  font-size: 14px;
  color: #cbcacd;
`,M=()=>o.jsx(n,{children:o.jsx(j,{children:o.jsx(C,{children:y.map(i=>{const l=i.title=="Atletica"?"high":"auto";return o.jsxs(T,{href:i.href,children:[o.jsx(q,{src:i.imgSrc,alt:i.title,fetchPriority:l}),o.jsxs(B,{children:[o.jsx(D,{children:i.title}),i.format&&o.jsxs(a,{children:[o.jsx("strong",{children:"Formato: "}),i.format]}),i.participants&&o.jsxs(a,{children:[o.jsx("strong",{children:"Partecipanti: "}),i.participants]}),i.description&&o.jsxs(a,{children:[o.jsx("strong",{children:"Descrizione: "}),i.description]})]})]},i.href)})})})});export{M as default};
