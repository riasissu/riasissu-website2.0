...
`,a=r.div`
  ...
  font-size: 14px;
  color: #cbcacd;
`,L=()=>o.jsx(n,{children:o.jsx(C,{children:o.jsx(T,{children:j.map(i=>{const l=i.title=="Atletica"?"high":"auto";return o.jsxs(D,{href:i.href,children:[o.jsx(q,{src:i.imgSrc,alt:i.title,fetchPriority:l}),o.jsxs(B,{children:[o.jsx(k,{children:i.title}),i.format&&o.jsxs(a,{children:[o.jsx("strong",{children:"Formato: "}),i.format]}),i.participants&&o.jsxs(a,{children:[o.jsx("strong",{children:"Partecipanti: "}),i.participants]}),i.description&&o.jsxs(a,{children:[o.jsx("strong",{children:"Descrizione: "}),i.description]})]})]},i.href)})})})});export{L as default};
