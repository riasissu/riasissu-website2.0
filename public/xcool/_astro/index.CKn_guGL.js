...
`,F=({link:t,target:n,children:a,align:i,showIcon:g=!1,variant:d="primary",asButton:s,type:z,onClick:p,...l})=>{const m=s?_:h;return r.jsx(j,{$align:i,children:r.jsxs(m,{href:s?void 0:t,target:n,onClick:s?p:void 0,...l,$variant:d,children:[g&&r.jsx(C,{iconData:"arrowRight",alt:"arrow icon"}),a]})})};export{F as B,C as I};
